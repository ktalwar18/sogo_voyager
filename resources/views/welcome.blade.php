          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="{{ Voyager::image( $room->image ) }}" alt="Free website template" class="img-fluid mb-3">
              </figure>
          ...
          <div class="col-md-12">
            ...
            <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              <div class="slider-item">
                <a href="{{ Voyager::image( $photo->image ) }}" data-fancybox="images" data-caption="Caption for this image"><img src="{{ Voyager::image( $photo->image ) }}" alt="Image placeholder" class="img-fluid"></a>
              </div>
            @endforeach
              {{-- <div class="slider-item">
              ...
              <div class="row">
                ...
                @foreach ($menus as $key => $menu)
                  ...
                  <div class="food-menu mb-5">
                    <span class="d-block text-primary h4 mb-3">${{$menu->price}}</span>
                    <h3 class="text-white"><a href="#" class="text-white">{{$menu->name}}</a></h3>
                    <p class="text-white text-opacity-7">{!!$menu->description!!}</p>
                  </div>
                @endforeach
                  {{-- <div class="food-menu mb-5">
              ...
              <div class="row">
                ...
                @foreach ($desserts as $key => $dessert)
                  ...
                  <div class="food-menu mb-5">
                    ...
                    <h3 class="text-white"><a href="#" class="text-white">{{$dessert->name}}</a></h3>
              ...
              <div class="row">
                ...
                @foreach ($drinks as $key => $drink)        
                  <div class="food-menu mb-5">
                    ...
                    <h3 class="text-white"><a href="#" class="text-white">{{$drink->name}}</a></h3>
